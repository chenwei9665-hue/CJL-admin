...
export function Navbar() {
  ...
  return (
    <header className={`sticky top-0 z-50 transition ${scrolled ? "bg-white/90 shadow-sm backdrop-blur" : "bg-background/80 backdrop-blur"}`}>
      <div className="section-shell flex h-20 items-center justify-between">
        <a href="#" className="flex items-center gap-3 font-bold">
          <span className="grid h-10 w-10 place-items-center rounded-xl bg-gradient-to-br from-primary to-sky-700 text-white">财</span>
          财精灵
        </a>
